...
【触发条件】在一个签署流程中，某个审批任务成功发起<font style="color:#DF2A3F;">（目前只有签署中企业印章的用印审批类型）</font>，触发此回调通知。
...
| **参数名** | | | **必填** | **参数类型** | **说明** |
| --- | --- | --- | :---: | :---: | --- |
| action | | | 是 | string | 标记该通知的业务类型，该通知固定为：**<font style="color:#52C41A;"></font>**<br/>**<font style="color:#52C41A;">PARTNER_APPROVAL_NOTICE</font>** |
...
```json
{
    "action": "PARTNER_APPROVAL_NOTICE",
