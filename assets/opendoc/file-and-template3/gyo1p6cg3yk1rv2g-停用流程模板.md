### 接口描述
<font style="color:rgb(51, 51, 51);">停用流程模板后，模板不可使用。但如果需要编辑原有模板，模板必须先做停用设置，才可以再次编辑模板。当前接口对应官网的停用模板按钮，如图：</font>

![](https://cdn.nlark.com/yuque/0/2023/png/447795/1676875238250-49a5186d-a78d-4986-b8ae-1fc8d77ff207.png)

### 接口地址&请求方法
**接口地址：**https://[{host}](https://qianxiaoxia.yuque.com/docs/share/5d0a9747-9e48-4854-9169-ae3710449aa5?#JsWHg)/v3/sign-templates/disable
