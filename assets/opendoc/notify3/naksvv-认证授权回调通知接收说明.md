...
+ 每当，认证和授权相关事件发生时（如完成实名认证），e签宝通知服务将会创建一个JSON对象，其中包含事件类型和与该事件相关的数据等信息。
...
![](https://cdn.nlark.com/yuque/__puml/d2ed0224fa63b69428a28dcf48451a5e.svg)
...
[点击跳转 开放平台订阅回调通知配置方式](https://qianxiaoxia.yuque.com/opendoc/notify3/pmy852#d29GV)，勾选【v3版认证授权】相关配置项。

**方式二：接口设置：**

开发者可通过[【获取个人认证&授权页面链接】](https://qianxiaoxia.yuque.com/books/share/66e3a742-d03c-445a-89cc-622ecfce55a0/rx8igf)或[【获取机构认证&授权页面链接】](https://qianxiaoxia.yuque.com/books/share/66e3a742-d03c-445a-89cc-622ecfce55a0/kcbdu7)接口中的`**<font style="color:#FA8C16;">notifyUrl</font>**`请求参数来配置认证和授权类回调通知Url地址。<font style="color:#DF2A3F;">（接口设置不包含授权范围变更通知）</font>

### 2.3 接收并响应
#### 2.3.1 接收e签宝回调通知
当某个事件发生后，e签宝会主动 POST 请求开发者所设置的回调通知 Url 地址，并推送对应的事件数据信息。

例如：当完成实名认证或授权操作后，e签宝将推送实名认证通过事件数据信息。
...
| --- | --- |
| **<font style="color:#E8323C;">认证授权类通知事件</font>** | |
