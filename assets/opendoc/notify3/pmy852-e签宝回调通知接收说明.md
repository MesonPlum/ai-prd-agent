...
+ 每当，相关事件发生时，e签宝通知服务将会创建一个JSON对象，其中包含事件类型和与该事件相关的数据等信息。
+ 然后，e签宝通知服务通过 HTTP POST 请求将JSON对象发送到开发者配置的回调通知 Web Url中。
+ 开发者业务系统在收到回调通知后，可根据事件类型和相关数据做下一步的业务处理。
+ 若开发者业务系统所在网络有安全策略限制，请查阅[附3 e签宝回调通知服务器信息](#KyEtR)进行防火墙配置。

其流程描述如下：

![](https://cdn.nlark.com/yuque/__puml/e1f1a6531be37830ca29756f39fb1250.svg)
...
![](https://cdn.nlark.com/yuque/0/2024/png/447795/1735278162579-663fcc76-f38d-4f9d-970b-ce69726eb43c.png)

:::warning
**<font style="color:#DF2A3F;">【提示】</font>**：关于e签宝全网通知说明 [请点击了解](https://qianxiaoxia.yuque.com/opendoc/notify3/etrrn6c04lb0294i)。
...
可通过查看文末[附1 Action事件列表](#juMxj)了解签署类相关事件的回调通知数据。
...
（不同的模块可能走以下两种不同的重试机制，若中间重试通知成功，则中断不再继续重试）：![](https://cdn.nlark.com/yuque/0/2024/png/447795/1706666848321-21b2cc93-9417-4f91-b7c1-01b604a86dad.png) ![](https://cdn.nlark.com/yuque/0/2024/png/447795/1706666689888-134f9a97-b213-44f7-9a76-447b9e674bd4.png)
...
## 附1 Action事件列表
开发者可通过判断e签宝通知服务推送的 JSON 中的 **Action **事业类型，从而进行下一步业务处理。

不同类型事件的 Action 参数值和 JSON 数据内容均不同，请查阅具体事件的回调通知接收说明。
