...
+ 每当，签署相关事件发生时（如签署人完成签章），e签宝通知服务将会创建一个JSON对象，其中包含事件类型和与该事件相关的数据等信息。
...
![](https://cdn.nlark.com/yuque/__puml/484fbab325687297b9217703a2d4df9f.svg)
...
[点击跳转 开放平台订阅回调通知配置方式](https://qianxiaoxia.yuque.com/opendoc/notify3/pmy852#d29GV)，勾选【v3版签署服务】相关配置项。

**方式二：接口设置：**

开发者可通过[【基于文件发起签署】](https://qianxiaoxia.yuque.com/books/share/ab6f4376-8c8c-4422-9be6-713ab7d7b98b/su5g42)/[【通过页面发起签署】](https://qianxiaoxia.yuque.com/opendoc/pdf-sign3/lp54bn)接口中的`**<font style="color:#FA8C16;">notifyUrl</font>**`参数来配置签署类回调通知Url地址。
