...
### 2.2 设置回调通知Url地址
不同类型事件的回调通知Url地址配置方式不同，请查阅具体事件的回调通知接收说明来操作配置。
...
+ 通知失败后，e签宝通知服务将会进行最多<font style="color:#E8323C;">2次重试</font>通知。重试机制如下：

![](https://cdn.nlark.com/yuque/0/2024/png/447795/1706666848321-21b2cc93-9417-4f91-b7c1-01b604a86dad.png)
