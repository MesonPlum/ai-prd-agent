...
### 接口描述
当印章被停用后，可以通过该接口重新启用印章。启用后，印章变成可用状态。

### 接口地址&请求方法
**接口地址：**https://[{host}](https://qianxiaoxia.yuque.com/docs/share/5d0a9747-9e48-4854-9169-ae3710449aa5?#JsWHg)/v3/seals/org-seals/enable-seal
