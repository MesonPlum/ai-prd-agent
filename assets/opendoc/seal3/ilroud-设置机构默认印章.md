...
### 接口描述
机构用户在完成实名认证时，e签宝会为企业生成4个印章（包括：公章、合同专用章、财务专用章、人事专用章），其中的公章作为企业默认印章，如需更改默认印章，可通过此接口进行设置。

### 接口地址&请求方法
**接口地址：**https://[{host}](https://qianxiaoxia.yuque.com/docs/share/5d0a9747-9e48-4854-9169-ae3710449aa5?#JsWHg)/v3/seals/org-seals/set-default-seal
