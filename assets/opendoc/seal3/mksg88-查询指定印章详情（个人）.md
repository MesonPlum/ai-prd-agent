...
### 接口地址&请求方法
**接口地址：**https://[{host}](https://qianxiaoxia.yuque.com/docs/share/5d0a9747-9e48-4854-9169-ae3710449aa5?#JsWHg)/v3/seals/psn-seal-info?psnId=xx&sealId=xx
...
### 请求示例
```http
GET https://openapi.esign.cn/v3/seals/psn-seal-info?psnId=c7e007**41e7&sealId=1caebb40***31f7f95087de
```
