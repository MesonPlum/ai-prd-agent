...
### 接口描述
指定具体的机构印章（只支持企业内部印章，不包含授权的印章），查询印章详细信息。

### 接口地址&请求方法
**接口地址：**https://[{host}](https://qianxiaoxia.yuque.com/docs/share/5d0a9747-9e48-4854-9169-ae3710449aa5?#JsWHg)/v3/seals/org-seal-info?orgId=xx&sealId=xx
...
### 请求示例
```http
GET https://openapi.esign.cn/v3/seals/org-seal-info?orgId=c7e007**41e7&sealId=53642310-xx-xx-xx-xxx
```
