...
|---|---|---|---|---|---|
| F-001 | 认证授权与免登体系 | auth3 | ✅ 已上线 | ✅ released | prds/F-001-认证授权与免登体系/prd.md |
| F-002 | 文件&流程模板管理 | file-and-template3 | ✅ 已上线 | ✅ released | prds/F-002-文件&流程模板管理/prd.md |
| F-003 | 签署流程(含查询、下载) | pdf-sign3 | ✅ 已上线 | ✅ released | prds/F-003-签署流程（含查询和下载）/prd.md |
| ~~F-004~~ | ~~(已废弃,E-001 v1.4 拆分至 F-001/F-003/F-007/F-008)~~ | — | — | — | 编号不再复用 |
| F-005 | 印章管理 | seal3 | ✅ 已上线 | ✅ released | prds/F-005-印章管理/prd.md |
| F-006 | 企业成员管理 | employee | ✅ 已上线 | ✅ released | prds/F-006-企业成员管理/prd.md |
